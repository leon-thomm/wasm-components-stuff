(module
  ...
  (func $secret (type 3) (result i32)
    i32.const 0
    i32.const 1
    i32.store8 offset=1049160
    i32.const 0
    i32.const 0
    i32.store8 offset=1049168
    i32.const 1049160)
  ...
  (func $_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$7reserve21do_reserve_and_handle17hfb3f3765e4659896E (type 4) (param i32 i32 i32)
    ...
    unreachable)
  (func $_ZN4core3ptr100drop_in_place$LT$$RF$mut$u20$std..io..Write..write_fmt..Adapter$LT$alloc..vec..Vec$LT$u8$GT$$GT$$GT$17h78793134c92f917cE (type 7) (param i32))
  (func $_ZN4core3ptr226drop_in_place$LT$std..error..$LT$impl$u20$core..convert..From$LT$alloc..string..String$GT$$u20$for$u20$alloc..boxed..Box$LT$dyn$u20$std..error..Error$u2b$core..marker..Send$u2b$core..marker..Sync$GT$$GT$..from..StringError$GT$17h994e3ac4e313ea83E (type 7) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.const 4
  ...
  (func $_ZN4core3ptr70drop_in_place$LT$std..panicking..begin_panic_handler..PanicPayload$GT$17h2e7bd6e17b28fee8E (type 7) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.load offset=4
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$13dispose_chunk17hcee5823f6f3f188bE (type 0) (param i32 i32)
    ...
    local.get 2
    i32.store offset=8)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$18unlink_large_chunk17hf01b17aae28bee8bE (type 7) (param i32)
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$18insert_large_chunk17h222cbd56e41cc2d5E (type 0) (param i32 i32)
    ...
    local.get 4
    i32.store offset=12)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$23release_unused_segments17hc8fc2fc6333ff4c3E (type 3) (result i32)
    ...
    i32.store offset=1049648
    local.get 2)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$4free17hf3b1d8fb572d9238E (type 7) (param i32)
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$8init_top17he46fe91f1208ee07E (type 0) (param i32 i32)
    ...
    i32.const 2097152
    i32.store offset=1049640)
  (func $_ZN3std10sys_common9backtrace26__rust_end_short_backtrace17h004afb3e6a867c40E (type 7) (param i32)
    local.get 0
    i32.load
    local.get 0
    i32.load offset=4
  ...
  (func $_ZN93_$LT$std..panicking..begin_panic_handler..StrPanicPayload$u20$as$u20$core..panic..BoxMeUp$GT$3get17h9bbdbf24fa06448aE (type 0) (param i32 i32)
    ...
    local.get 1
    i32.store)
  (func $_ZN3std9panicking20rust_panic_with_hook17hb09154fa23e06c37E (type 10) (param i32 i32 i32 i32 i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN8dlmalloc8dlmalloc24leftshift_for_tree_index17hc0d020fae6b0b706E (type 8) (param i32) (result i32)
    ...
    i32.eq
    select)
  (func $_ZN8dlmalloc8dlmalloc5Chunk14fencepost_head17hbb0668b23af3a868E (type 3) (result i32)
    i32.const 7)
  ...
  (func $_ZN8dlmalloc8dlmalloc5Chunk6pinuse17h40769efd9ae2196bE (type 8) (param i32) (result i32)
    ...
    i32.const 1
    i32.and)
  (func $_ZN8dlmalloc8dlmalloc5Chunk12clear_pinuse17hb355fc9e70009219E (type 7) (param i32)
    local.get 0
    local.get 0
    i32.load offset=4
    i32.const -2
  ...
  (func $_ZN8dlmalloc8dlmalloc5Chunk6to_mem17h34d6fd7a820f1b88E (type 8) (param i32) (result i32)
    ...
    i32.const 8
    i32.add)
  (func $_ZN8dlmalloc8dlmalloc5Chunk10mem_offset17h2d1bbb3aeaf87169E (type 3) (result i32)
    i32.const 8)
  ...
  (func $_ZN61_$LT$dlmalloc..sys..System$u20$as$u20$dlmalloc..Allocator$GT$5alloc17h8223fe106c4cbbf4E (type 4) (param i32 i32 i32)
    ...
    select
    i32.store)
  (func $_ZN61_$LT$dlmalloc..sys..System$u20$as$u20$dlmalloc..Allocator$GT$5remap17hbf32c1444ebfbe2fE (type 11) (param i32 i32 i32 i32 i32) (result i32)
    i32.const 0)
  (func $_ZN61_$LT$dlmalloc..sys..System$u20$as$u20$dlmalloc..Allocator$GT$9free_part17h18e6c8938d290819E (type 5) (param i32 i32 i32 i32) (result i32)
    i32.const 0)
  ...
  (func $_ZN5alloc5alloc18handle_alloc_error17h202063363ecf6a39E (type 0) (param i32 i32)
    ...
    unreachable)
  (func $_ZN5alloc7raw_vec17capacity_overflow17h940094f9823ac227E (type 12)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN4core3ptr102drop_in_place$LT$$RF$core..iter..adapters..copied..Copied$LT$core..slice..iter..Iter$LT$u8$GT$$GT$$GT$17ha30bd7eefcc06f5fE (type 7) (param i32))
  ...
  (func $_ZN4core3str5count14do_count_chars17h3c13079806bf141aE (type 2) (param i32 i32) (result i32)
    ...
    local.get 8)
  (func $_ZN4core3fmt9Formatter12pad_integral12write_prefix17h1df58d8309afedf5E (type 5) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
  ...
  (func $canonical_abi_realloc (type 5) (param i32 i32 i32 i32) (result i32)
    block  ;; label = @1
      block  ;; label = @2
        block  ;; label = @3
          block  ;; label = @4
  ...
  (global (;1;) i32 (i32.const 1049656))
